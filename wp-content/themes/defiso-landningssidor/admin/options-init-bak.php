        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'opt-secondary-theme-color',
                        'type'      => 'color',
                        'title'     => __('Sekundär färg', 'redux-framework-demo'),
                        'subtitle'  => __('Om ingen sekundär färg existerar, använd samma som den primära färgen', 'redux-framework-demo'),
                        'default'   => '#dd9933',
                        'validate'  => 'color',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'mode'      => 'javascript',
                        'theme'     => 'chrome',
                        'desc'      => 'Koden importeras precis innan body stängs',
